...
spip to sample 1% of the fish of ages 0, 1, and 2 (before the episode of 
death) every year from 50 to 75.
```{r}
samp_frac <- 0.01
samp_start_year <- 50
samp_stop_year <- 75
...
Because this simulated popluation is quite small, at this juncture we will reduce
...
one_gen_graph <- plot_conn_comps(crel_1gen)
one_gen_graph
...
And, for fun, look at it with 2 generations:
```{r, fig.width=6, fig.height=6}
plot_conn_comps(crel)
